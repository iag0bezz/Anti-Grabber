...
public static class HostStrings
{
    private static readonly Dictionary<string, Dictionary<string, string>> Dict = new()
    {
        ["pt"] = new()
        {
            ...
            ["menu.quit"] = "Sair",
            ["quit.heading"] = "Fechar o AntiGrabber",
            ["quit.body"] = "\"Continuar proteção\" fecha esta janela, mas a proteção contra roubo de dados continua ativa em segundo plano — igual antes.\n\n\"Sair e parar proteção\" desliga tudo, inclusive o serviço de proteção. O Windows vai pedir confirmação de administrador.",
            ["quit.keepProtection"] = "Continuar proteção",
            ["quit.stopProtection"] = "Sair e parar proteção",
        ...
        ["en"] = new()
        {
            ...
            ["menu.quit"] = "Quit",
            ["quit.heading"] = "Close AntiGrabber",
            ["quit.body"] = "\"Keep protection\" closes this window, but protection against data theft stays active in the background — same as before.\n\n\"Quit and stop protection\" shuts everything down, including the protection service. Windows will ask for administrator confirmation.",
            ["quit.keepProtection"] = "Keep protection",
            ["quit.stopProtection"] = "Quit and stop protection",
        ...
        ["es"] = new()
        {
            ...
            ["menu.open"] = "Abrir AntiGrabber",
            ["menu.quit"] = "Salir",
            ["quit.heading"] = "Cerrar AntiGrabber",
            ["quit.body"] = "\"Continuar protección\" cierra esta ventana, pero la protección contra robo de datos sigue activa en segundo plano — igual que antes.\n\n\"Salir y detener protección\" apaga todo, incluido el servicio de protección. Windows pedirá confirmación de administrador.",
            ["quit.keepProtection"] = "Continuar protección",
            ["quit.stopProtection"] = "Salir y detener protección",
